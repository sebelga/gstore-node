...
class Model extends Entity {
    ...
    static get(id, ancestors, namespace, transaction, options = {}) {
        ...
        ids = ids.map(_this.parseId, _this);
    ...
    static delete(id, ancestors, namespace, transaction, key, options = {}) {
        ...
        id = multiple ? id.map(_this.parseId, _this) : _this.parseId(id);
    ...
    static parseId(id) {
        ...
        if (is.string(id)) {
            ...
            if (options.keyType === 'id') {
                return this.gstore.ds.int(id);
            }
            // auto convert string number to number
            return isFinite(id) ? this.gstore.ds.int(id) : id;
        }

        if (this.gstore.ds.isInt(id)) {
            return id;
        }
