...
class Model extends Entity {
    ...
    static get(id, ancestors, namespace, transaction, options, cb) {
         ...
         * it will forward the call to the fetchHandler passed
         * with the original keys.
         * If the cache has *some* keys but not all, it will call
         * the fetch handler only with the missing keys and then
         * save those in its cache before merging all entities
         * (catch + from fetch) for the final respone.
         */
