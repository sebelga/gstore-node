    ...
    class Model extends Entity{
        ...
        static query(namespace) {
            ...
            query.run = function(options, cb) {
                ...
                options = utils.options(_this.schema.options.queries, options);
        ...
        static findAround(property, value, options, cb) {
            ...
            this.ds.runQuery(query, (err, entities) => {
                ...
                let simplifyResult = options.simplifyResult ? options.simplifyResult : _this.schema.options.queries.simplifyResult;
