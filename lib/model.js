    ...
    */
    ...
    class Model extends Entity{
        ...
        static get(id, ancestors, namespace, transaction, cb) {
            ...
            cb          = args.pop();
            id          = (is.array(id) || !isFinite(id)) ? id : parseInt(id);
        ...
        static update(id, data, ancestors, namespace, transaction, options, cb) {
            ...
            /**
             * If options.replacd is set to true we don't fetch the entity
            ...
            if (typeof transaction === 'undefined' || transaction === null) {
                this.ds.runInTransaction(function(transaction, done) {
                    getInTransaction(transaction, done);
                }, onTransaction);
            } else {
                if (transaction.constructor.name !== 'Transaction') {
                    throw Error('Transaction needs to be a gcloud Transaction');
        ...
        static key(ids, ancestors, namespace) {
            ...
            function getPath(id, ancestors) {
                ...
                if (typeof id !== 'undefined' && id !== null) {
                    id = !isFinite(id) ? id : parseInt(id, 10);
                    path.push(id);
                }
